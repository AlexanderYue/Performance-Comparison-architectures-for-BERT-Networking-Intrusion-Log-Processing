...
LOCAL_MODEL_PATH = "local_model_files" 
BERT_BASE_TOKENIZER = "bert-base-uncased" 
TEST_LOGS_DIR = "small_logs" 

BATCH_SIZE = 128 
OUTPUT_FILE = "classification_output.jsonl" 
METRICS_REPORT_FILE = "benchmark_report.json" # NEW: File for performance metrics


# --- NEW: THRESHOLD CONFIGURATION ---
# Default threshold (0.5) classifies based on highest probability.
...
# --- NEW: Function to Write Performance Report to JSON (.json) ---
...
def load_and_run_benchmark():
    ...
    with open(OUTPUT_FILE, 'w') as outfile:
        ...
        for i in pbar: 
            ...
            # FIX FOR BFLOAT16 ERROR: Convert to float32 before moving to NumPy
            probabilities_cpu = probabilities.cpu().float().numpy()
